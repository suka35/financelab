...
#B[t,T] = (1-np.exp(-kapa(T-t)))
#A[t,T] = (rbar - (sigma_r/kapa)*lam_r - 0.5*((sigma_r/kapa)**2)) * (B[r, T] - (T-t) - ((sigma_r)**2/(4*kapa)*B**2*(t,T)))
